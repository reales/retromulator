...
#include "../core/virtmem.h"
  ...
  // Apple recently introduced MAP_JIT flag, which we want to use.
    ...
    #endif
    #include <libkern/OSCacheControl.h> // sys_icache_invalidate() — available on macOS and iOS.
...
[[maybe_unused]] static int getOSXVersion() noexcept {
...
void flushInstructionCache(void* p, size_t size) noexcept {
  ...
  // sys_icache_invalidate is available on both macOS and iOS via <libkern/OSCacheControl.h>
